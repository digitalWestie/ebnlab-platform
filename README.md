...
```sh
git clone https://github.com/digtalWestie/ebnlab-platform ebnlab-platform
cd ebnlab-platform
...
The app is named `ebn_lab` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "ebn_lab" and update a few Docker related resources.
